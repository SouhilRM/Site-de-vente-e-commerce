                    ...
                    <div class="item">
                        ...
                        <div class="product-micro">
                            ...
                            <div class="col col-xs-5">
                                ...
                                <div class="image"> <a href="{{ route('product.details',[$special_offer[$k]->product_slug_en,$special_offer[$k]->id]) }}"> <img src="{{ asset($special_offer[$k]->product_thambnail) }}" alt=""> </a> </div>
                                <!-- /.image --> 
                            ...
                            <div class="col col-xs-7">
                                ...
                                <h3 class="name">
                                    <a href="{{ route('product.details',[$special_offer[$k]->product_slug_en,$special_offer[$k]->id]) }}">
